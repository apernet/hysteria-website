...
7. The path to the ECH config file generated by `hysteria generate ech-keypair`. See [Encrypted Client Hello (ECH)](Full-Server-Config.md#encrypted-client-hello-ech) in the server configuration for more details on generating the key pair.
