...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | -------------- |
| [libHysteria2](https://github.com/CodeWithTamim/libHysteria2)              | A high-performance Hysteria 2 client and library written in Go, designed for easy integration and development                | Windows, Linux, macOS, Android     | client & library |
