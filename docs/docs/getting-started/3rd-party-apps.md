...
| [C³ CELERITY](https://github.com/ClickDevTech/CELERITY-panel)              | Web panel for Hysteria 2 with HTTP auth, one-click node setup, server groups, and load balancing                           | Linux                               | panel          |
